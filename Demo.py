...
data = pd.DataFrame({"Product_Url" : [], "Product Name" : [], "Price" : [], "Ratings" : [], "ram_size":[],"camera_details":[],"battery_details":[],"Processor":[],"product_color":[],"model_name":[],"display_size":[],"display_type":[],"resolution":[],"operating_system":[],"processor_type":[],"internal_storage":[]})
