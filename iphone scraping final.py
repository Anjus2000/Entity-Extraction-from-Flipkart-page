...
#Function for getting  name of iphone
...
#Function for getting  prices of iphone
...
#Function for getting ratings of iphone
...
#Function for getting rom of iphone
...
#Function for getting display of iphone
...
##Function for getting front camera of iphone
...
#Function for getting  processor of iphone
...
data = pd.DataFrame({"Product_Url" : [], "Product Name" : [], "Price" : [], "Ratings" : [], "Rom" : [],"Display" : [], "Front Camera" : [], "Processor" : []})
